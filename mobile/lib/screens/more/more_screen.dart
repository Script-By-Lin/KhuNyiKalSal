              ...
              if (isVolunteer || isOrg || isAdmin) ...[
                ...
                if (isAdmin)
                  _menuTile(
                    ...
                    subtitle: 'Please access the full admin dashboard via Web Browser',
                    onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('🖥️ Admin Console: Please open the Web Command Center in your browser on desktop/laptop.'),
